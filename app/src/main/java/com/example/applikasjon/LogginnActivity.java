 ...
 */
public class LogginnActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.epost);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.passord);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.loggInnKnapp);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LogginnActivity.this,
